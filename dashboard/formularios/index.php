...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../formularios/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Formularios",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
$eliminar = "eliminarFormularios";

$insertar = "insertarFormularios";
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=formularios",
			"language": {
		...
		$('#leyenda2').val('<?php echo $leyenda2; ?>');
		$('#leyenda3').val('<?php echo $leyenda3; ?>');
		...
		function validar() {
			if (($('#aceptacondiciones').prop('checked')) && ($('#opcion2').prop('checked')) && ($('#opcion3').prop('checked'))) {
				return true;
			}
			return false;
		}
		...
		$('.nuevo').click(function(){
			...
			if (validar()) {
				...
				swal({
						title: "Respuesta",
						text: 'Debe aceptar todos las condiciones',
						type: "error",
						timer: 2500,
						showConfirmButton: false
				});
