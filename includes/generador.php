...
$tablasAr	= array('formularios' => 'dbformularios',
'leyendas' => 'tbleyendas');


function recursiveTablas($ar, $tabla, $aliasTablaMadre) {

	$tablasArAux2	= array('formularios' => 'dbformularios',
	'leyendas' => 'tbleyendas');

	$tablasArAux	= array('formularios' => 1,
'leyendas' => 1);
...
$sqlMapaer	= "SHOW FULL TABLES FROM trendmap";
